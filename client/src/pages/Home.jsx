  ...
  return (
    <div className="w-full h-[50vh]" >
      <div className="w-7/12 mx-auto my-[100px] block  text-center">
        ...
        <p
          className="my-10 text-[20px] opacity-0 fadeInAnimation"
          style={{
            animationDelay: "0.3s",
          }}
        >
          A new way to store and organise your work and notes
        </p>
        <img
          src="home_page_image.png"
          className="mx-auto h-[400px] opacity-0 fadeInAnimation"
          style={{
            animationDelay: "0.5s",
          }}
          alt=""
